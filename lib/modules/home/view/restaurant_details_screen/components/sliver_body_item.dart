...
class SliverBodyItems extends StatelessWidget {
  ...
  Widget _showDateTimeBottomSheet(ReservationController controller) {
          ...
          SizedBox(
            ...
            child: CupertinoDatePicker(
                ...
                onDateTimeChanged: (date) {
                  ...
                  print('The picked date and Time is: ${controller.dateTime}');
                }),
          ),
  ...
  ///reservation category
  Widget _doneButton(ReservationController controller) {
    return Padding(
